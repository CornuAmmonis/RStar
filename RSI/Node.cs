...
namespace RSI
{
	public class Node
	{
		...
		internal float mbrMinX = float.MaxValue, mbrMinY = float.MaxValue, mbrMaxX = -float.MaxValue, mbrMaxY = -float.MaxValue;
		internal float[] entriesMinX = null, entriesMinY = null, entriesMaxX = null, entriesMaxY = null;
		...
		public void AddEntry(float minX, float minY, float maxX, float maxY, int id) {
			ids[entryCount] = id;
		...
		public int FindEntry(float minX, float minY, float maxX, float maxY, int id) {
		...
		public void RecalculateMBRIfInfluencedBy(float deletedMinX, float deletedMinY, float deletedMaxX, float deletedMaxY) {
